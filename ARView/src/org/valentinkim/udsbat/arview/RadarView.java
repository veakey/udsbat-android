...
import org.valentinkim.udsbat.utils.Data;
...
public class RadarView{
	...
	public static float RADIUS = 60; //small screen 40
	/** Position on screen */
	...
	double [] latitudes = Data.getLatitudes();
	double [] longitudes = Data.getLongitudes();
